...
public interface ReadingRepository extends JpaRepository<Reading, Long>, JpaSpecificationExecutor<Reading> {
    ...
    @Query(value = """
            ...
            """,
            nativeQuery = true)
    List<Double> findAggregatedByUserIdAndHouseholdIdOrderByTimestamp(@Param("userId") Long userId,
    ...
    @Query(value = """
            ...
            """,
            nativeQuery = true)
    List<Object[]> findHourlyAggregatedByHousehold(@Param("userId") Long userId,
                                                   @Param("householdId") Long householdId,
                                                   @Param("from") LocalDateTime from,
                                                   @Param("excludedSource") String excludedSource);
    ...
    @Query(value = """
            ...
            """,
            nativeQuery = true)
    Double findLatestTotalConsumptionByHousehold(@Param("userId") Long userId,
                                                 @Param("householdId") Long householdId,
                                                 @Param("excludedSource") String excludedSource);
    ...
    @Query(value = """
            ...
            """,
            nativeQuery = true)
    List<Object[]> findDeviceContributionByHousehold(@Param("userId") Long userId,
                                                     @Param("householdId") Long householdId,
                                                     @Param("from") LocalDateTime from,
                                                     @Param("excludedSource") String excludedSource);
